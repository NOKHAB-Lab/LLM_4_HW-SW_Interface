...
################################################################################################
samples_updated = []
INPUT_JSON_GPT = 'gemini_responses_70by5_large.json'  # Replace with the actual filename
OUTPUT_JSON_GPT = 'gemini_responses_70by5_large_validated.json'  # Replace with the actual filename
