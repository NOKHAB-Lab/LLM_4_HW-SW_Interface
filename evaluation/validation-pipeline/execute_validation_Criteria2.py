...
################################################################################################
samples_updated = []
INPUT_JSON = f'DeepSeek_Train1_Responses_Variations_Evaluation_20thMay2025.json'  # Replace with the actual filename
OUTPUT_JSON = f'DeepSeek_Train1_Responses_Variations_Evaluation_20thMay2025_VALIDATED.json'  # Replace with the actual filename
...
################################################################################################
samples_updated = []
INPUT_JSON = f'Mistral_Train1_Responses_Variations_Evaluation_20thMay2025.json'  # Replace with the actual filename
OUTPUT_JSON = f'Mistral_Train1_Responses_Variations_Evaluation_20thMay2025_VALIDATED.json'  # Replace with the actual filename
data, samples, TOTAL_EXAMPLES = load_samples(INPUT_JSON)
logger.info(f"Starting validation of {TOTAL_EXAMPLES} Raspberry Pi code examples from the file {INPUT_JSON}")
